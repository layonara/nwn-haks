...
def build_haks():
    ...
    subprocess.call("nwn_erf -e HAK -c tilesets/t[d-n]* -f tiles2.hak && /bin/mv tiles2.hak /layonara/ee/userdir/hak/", shell=True, executable='/bin/bash')
    print "Processing tiles3 hak directory"
    subprocess.call("nwn_erf -e HAK -c tilesets/t[o-z]* -f tiles3.hak && /bin/mv tiles3.hak /layonara/ee/userdir/hak/", shell=True, executable='/bin/bash')
